...
public class CreateJobAPIWithDBValidationPractice {
	...
	public void setup() {
		...
		CustomerProduct customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "34497090442567",
				"34497090442567", "34497090442567", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(),
