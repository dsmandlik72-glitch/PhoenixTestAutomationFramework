...
//The job of the CreateJobBeanMapper is we will be giving the Bean and it will create the Payload for CreateJobAPI
...
//It's Utilty Clas	
	...
	public static CreateJobPayload mapper(CreateJobBean bean) {
		//This bean will be converted to CreateJobPayload Object.
		...
		CustomerAddress custAddress=new CustomerAddress(bean.getCustomer_address__flat_number(),
