...
public class CreateJobAPIWithDBValidationWithResponseModelTest {
	...
	@BeforeMethod(description = "Creating createjob api request payload and instanttiating the JobService")
	public void setup() {

		customer = new Customer("Dhananjay", "Shharma", "7045663552", "", "jatinvsharma@gmail.com", "");
		...
		customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "87197100442573", "87197100442573",
				"87197100442573", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(), Model.NEXUS_2_BLUE.getCode());
	...
	public void createJobAPITest() {
		...
		System.out.println("================================================");
		// System.out.println("Extracted Customer Id is: " + customerId);
		...
		System.out.println("-------------------------------------------------------");
		System.out.println("The TR Customer Address ID is: " + customerDataFromDB.getTr_customer_address_id());
